...
runTest2:
	g++ -Wall -Wextra -Wpedantic -std=c++11 test2.cpp -o runTest2

runTest3:
	g++ -Wall -Wextra -Wpedantic -std=c++11 test3.cpp -o runTest3

runTest4:
	g++ -Wall -Wextra -Wpedantic -std=c++11 test4.cpp -o runTest4
